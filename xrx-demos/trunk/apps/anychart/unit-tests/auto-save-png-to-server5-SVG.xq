...
<html>
	<head>
		<script type="text/javascript" language="javascript" src="/rest/db/dma/resources/js/anychart/js/AnyChart.js"></script>
		<script type="text/javascript" language="javascript" src="/rest/db/dma/resources/js/anychart/js/AnyChartHTML5.js"></script>
		<script type="text/javascript" language="javascript" src="auto-save-png-to-server5-SVG.js"></script>
