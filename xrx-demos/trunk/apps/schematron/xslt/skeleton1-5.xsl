...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:axsl="http://www.w3.org/1999/XSL/TransformAlias" xmlns:sch="http://purl.oclc.org/dsdl/schematron" version="1.0">
		...
		<!-- utility routine for implementations -->
            ...
            <axsl:template match="/">
                <xsl:call-template name="process-root">
                    ...
                    <xsl:with-param name="title" select="./sch:title | title"/>
