...
let $title := 'XRX Demon Marc Records Manager'

let $content := 
<div class="content">
      <p>Welcome to the {$title}.
      
      This application can be used as a basis for building other standard Marc record applications</p>
      
      
      <a href="views/list-items.xq">List Marc Records</a> A listing of items<br/>
