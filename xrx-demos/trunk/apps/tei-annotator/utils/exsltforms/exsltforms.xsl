...
Foundation, Inc., 51 Franklin St, Fifth Floor, Boston, MA  02110-1301  USA
	-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exfk="http://kuberam.ro/exsltforms" xmlns:exslt="http://exslt.org/common" xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:xforms="http://www.w3.org/2002/xforms" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:xalan="http://xml.apache.org/xalan" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.0" exclude-result-prefixes="xhtml xforms ev exfk">
    ...
    <xsl:template name="eXSLTForms">
        ...
        <meta name="exsltformsBaseURI" content="{$exsltformsBaseURI}"/>
...
<!--	<xsl:choose>
        ...
        <xsl:variable name="idInsertElem" select="concat('xf_insert_transform_', $idExtElem)"/>
        <xsl:variable name="idDeleteElem" select="concat('xf_delete_transform_', $idExtElem)"/>
        ...
        <xsl:value-of select="concat('var xf_transform_', $idExtElem, ' = new transform_action(&#34;', @origin, '&#34;, &#34;', @transformer, '&#34;, &#34;', @param, '&#34;, &#34;', @ref, '&#34;, &#34;transform_', $idExtElem, '&#34;);')"/>
        ...
        <xsl:value-of select="concat('new Listener(document.getElementById(&#34;xf-model-extensions&#34;),&#34;xforms-transform-insert_transform_', $idExtElem, '&#34;,null,function(evt) {run(', $idInsertElem, ',getId(evt.currentTarget ? evt.currentTarget : evt.target),evt,false,true);});')"/>
        <xsl:value-of select="concat('var ', $idDeleteElem, ' = new XFDelete(&#34;', @ref, '&#34;,null,null,null,null,null,null);')"/>
        <xsl:value-of select="concat('new Listener(document.getElementById(&#34;xf-model-extensions&#34;),&#34;xforms-transform-delete_transform_', $idExtElem, '&#34;,null,function(evt) {run(', $idDeleteElem, ',getId(evt.currentTarget ? evt.currentTarget : evt.target),evt,false,true);});')"/>
    ...
    <xsl:template match="xforms:replace" mode="script" priority="1">
        ...
        <xsl:value-of select="concat('var ',$idInsertElem, ' = new XFInsert(&#34;', @ref, '&#34;,null,null,null,&#34;after&#34;,&#34;', @origin, '&#34;,null,null,null);')"/>
