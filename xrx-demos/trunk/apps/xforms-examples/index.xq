...
let $title := 'XForms Examples'

let $content := 
<div class="content">
      <p>Welcome to the {$title}.
      
      This application is designed to demonstrate many of the XForms examples
      used in the XForms Tutorial and Cookbook Wikibook.</p>
      
      
      <a href="views/list-items.xq">List items</a> A listing of sample forms.<br/>
