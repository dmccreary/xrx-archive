...
(
xmldb:login('/db/dma/apps/ngram-search/data', 'admin', 'admin123'),
xmldb:reindex('/db/dma/apps/ngram-search/data')
)
...
let $reindex-result := xmldb:reindex('/db/dma/apps/ngram-search/data')
