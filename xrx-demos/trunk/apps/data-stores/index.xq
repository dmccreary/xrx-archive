...
let $title := 'Data Store Manager Application'

let $content := 
<div class="content">
      <p>Welcome to the {$title}.
      
      This application can be used as a basis for storing data store information such as
      systems, tables, columns, spreadsheets, XML files etc.</p>
      
      
      <a href="views/datastore-browse.xq">List items</a> A listing of items<br/>
