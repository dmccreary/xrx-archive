...
declare variable $sch-util:schema-data-collection := '/db/dma/apps/schema-to-svg/data';

declare variable $sch-util:all-element-names := collection($sch-util:schema-data-collection)//xs:element/@name/string();
