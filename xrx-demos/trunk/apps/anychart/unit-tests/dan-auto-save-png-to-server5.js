...
function saveChartAsImage(chart) {
	...
	var path = makeMultipartFormDataPostRequest('dan-save-png.xq',requestData);
	if (path != null) {
		//alert ("Image was saved to the server\nIt will be shown in a new window: "+path);
		//var w = window.open('', '', false);
		//w.document.write('<img src="/rest/db/tmp/test-img.png" />');					
	}
}
...
var chart = new AnyChart();
    ...
    /* after drawing is done this calls the saveChartAsImage function */
