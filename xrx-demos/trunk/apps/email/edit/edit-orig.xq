                ...
                <xforms:case id="case1" selected="true()">
                    ...
                    <fieldset>
                        <legend>
                            <xforms:trigger class="add" appearance="minimal">
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                            ...
                            <div class="section">
                                ...
                                <p class="deleteSection">
                                    <xforms:trigger appearance="minimal" ref="self::node()[count(../mods:titleInfo) &gt; 1]">
                                        <xforms:label><img src="images/remove.gif" alt="Remove"/></xforms:label>
                                ...
                                <dl class="optionalElements">
                                    ...
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[count(mods:nonSort) = 0]">
                                            <xforms:label><img src="images/add.gif"/>NonSort </xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:titleInfo[index('titleInfo')]/*" at="index('titleInfo')" position="after" origin="instance('template')/mods:titleInfo/mods:nonSort"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>

                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:subTitle) = 0]">
                                            <xforms:label><img src="images/add.gif"/>SubTitle</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:titleInfo[index('titleInfo')]/*" at="index('titleInfo')" position="after" origin="instance('template')/mods:titleInfo/mods:subTitle"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:partNumber) = 0]">
                                            <xforms:label><img src="images/add.gif"/> Part Number</xforms:label>

                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:titleInfo[index('titleInfo')]/*" at="index('titleInfo')" position="after" origin="instance('template')/mods:titleInfo/mods:partNumber"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:partName) = 0]">
                                            <xforms:label><img src="images/add.gif"/> Part Name</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:titleInfo[index('titleInfo')]/*" at="index('titleInfo')" position="after" origin="instance('template')/mods:titleInfo/mods:partName"/>
                                        </xforms:trigger>

                                    </dd>
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[not(@displayLabel)]">
                                            <xforms:label><img src="images/add.gif"/>Display Label</xforms:label>
                    ...
                    <fieldset>
                        <legend>
                            <xforms:trigger class="add" appearance="minimal">
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                                    <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="index('name')" position="after" origin="instance('basic')/mods:name"/>
                        ...
                        <div class="lookup">
                            ...
                            <p>
                                ...
                                <xforms:trigger class="add" appearance="minimal">
                                    <xforms:label><img src="images/add.gif" alt="Add"/>Add Selected</xforms:label>
                                        <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:name[last()]" at="index('name')" position="after" origin="instance('names')/*/*"/>
                                </xforms:trigger>
                                <xforms:select ref="instance('names')/*" appearance="full">

                                    <xforms:label/>
                                    <xforms:itemset nodeset="instance('response')/*">
                                        <xforms:label style="display: block;" ref="*/*"/>
                                        <xforms:copy ref="*"/>
                                    </xforms:itemset>
                                </xforms:select>
                                <br class="clear"/>
                                ...
                                <dl class="optionalElements">
                                    ...
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[not(@type)]">
                                            <xforms:label><img src="images/add.gif"/>Type</xforms:label>
                                    ...
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[not(@authority)]">
                                            ...
                                            <xforms:label><img src="images/add.gif"/>Authority</xforms:label>
                                    ...
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:namePart[@type='date']) = 0]">
                                            <xforms:label><img src="images/add.gif"/> Date</xforms:label>

                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:name[index('name')]/*" at="index('name')" position="after" origin="instance('template')/mods:name/mods:namePart[@type='date']"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:role) = 0]">
                                            <xforms:label><img src="images/add.gif"/> Role </xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:name[index('name')]/*" at="index('name')" position="after" origin="instance('template')/mods:name/mods:role"/>
                                        </xforms:trigger>
                                ...
                                <div class="left">
                                        ...
                                        <xforms:repeat nodeset="mods:placeTerm" id="placeTermInfo">
                                            <p>
                                                ...
                                                <xforms:trigger class="delete" appearance="minimal" ref="self::node()[not(@type='code')]">
                                                  <xforms:label><img src="images/remove.gif" alt="Remove"/></xforms:label>
                                                    <xforms:delete ev:event="DOMActivate" nodeset=".." at="index('placeInfo')"/>
                                                </xforms:trigger>
                                            </p>
                                        </xforms:repeat>
                                    </xforms:repeat>
                                    ...
                                    <p>
                                        ...
                                        <xforms:trigger class="delete" appearance="minimal" ref="self::node()[count(mods:issuance) &gt; 0]">
                                            <xforms:label><img src="images/remove.gif" alt="Remove"/>
                                ...
                                <dl class="optionalElements">
                                    ...
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:place) = 0]">
                                            <xforms:label><img src="images/add.gif"/>Place</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:originInfo[index('originInfo')]/*" at="index('originInfo')" position="after" origin="instance('template')/mods:originInfo/mods:place[1]"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:publisher) = 0]">

                                            <xforms:label><img src="images/add.gif"/>Publisher</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:originInfo[index('originInfo')]/*" at="index('originInfo')" position="after" origin="instance('template')/mods:originInfo/mods:publisher"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:edition) = 0]">
                                            <xforms:label><img src="images/add.gif"/>Edition</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:originInfo[index('originInfo')]/*" at="index('originInfo')" position="after" origin="instance('template')/mods:originInfo/mods:edition"/>

                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:issuance) = 0]">
                                            <xforms:label><img src="images/add.gif"/>Issuance</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:originInfo[index('originInfo')]/*" at="index('originInfo')" position="after" origin="instance('template')/mods:originInfo/mods:issuance"/>
                                        </xforms:trigger>
                                    </dd>

                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:frequency) = 0]">
                                            <xforms:label><img src="images/add.gif"/>Frequency</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:originInfo[index('originInfo')]/*" at="index('originInfo')" position="after" origin="instance('template')/mods:originInfo/mods:frequency"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:dateCaptured) = 0]">

                                            <xforms:label><img src="images/add.gif"/> Date Captured</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:originInfo[index('originInfo')]/*" at="index('originInfo')" position="after" origin="instance('template')/mods:originInfo/mods:dateCaptured[1]"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:dateIssued) = 0]">
                                            <xforms:label><img src="images/add.gif"/> Date Issued</xforms:label>

                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:originInfo[index('originInfo')]/*" at="index('originInfo')" position="after" origin="instance('template')/mods:originInfo/mods:dateIssued[1]"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:dateCreated) = 0]">
                                            <xforms:label><img src="images/add.gif"/> Date Created</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:originInfo[index('originInfo')]/*" at="index('originInfo')" position="after" origin="instance('template')/mods:originInfo/mods:dateCreated[1]"/>
                                        </xforms:trigger>

                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:copyrightDate) = 0]">
                                            <xforms:label><img src="images/add.gif"/>Copyright Date</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:originInfo[index('originInfo')]/*" at="index('originInfo')" position="after" origin="instance('template')/mods:originInfo/mods:copyrightDate[1]"/>
                                        </xforms:trigger>
                                    </dd>
                                    <!--<dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:dateOther) = 0]">
                                            <xforms:label><img src="images/add.gif"/>Other Date</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:originInfo[index('originInfo')]/*" at="index('originInfo')" position="after" origin="instance('template')/mods:originInfo/mods:dateOther[1]"/>
                                        </xforms:trigger>
                                    </dd>-->
                ...
                <xforms:case id="case2" selected="false()">
                    ...
                    <fieldset>
                        <legend>
                            <xforms:trigger class="add" appearance="minimal">
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                                    <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="last()" position="after" origin="instance('basic')/mods:language"/>
                                ...
                                <dl class="optionalElements">
                                    ...
                                    <dd>
                                        ...
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[not(mods:languageTerm[@type ='code'])]">
                                            <xforms:label><img src="images/add.gif"/> Code</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:language[index('langInfo')]/*" at="index('langInfo')" position="after" origin="instance('template')/mods:language/mods:languageTerm[@type = 'code']"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[not(mods:languageTerm[@type ='text'])]">
                                            <xforms:label><img src="images/add.gif"/> Text</xforms:label>

                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:language[index('langInfo')]/*" at="index('langInfo')" position="after" origin="instance('template')/mods:language/mods:languageTerm[@type = 'text']"/>
                                        </xforms:trigger>
                                    </dd>
                                </dl>
                                <br class="clear"/>
                    ...
                    <fieldset>
                        ...
                        <legend>
                            <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(instance('metadata')/mods:physicalDescription) &lt; 1]">
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                                    <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="last()" position="after" origin="instance('basic')/mods:physicalDescription"/>
                                ...
                                <dl class="optionalElements">
                                    ...
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[count(mods:form) = 0]">
                                            <xforms:label><img src="images/add.gif"/> Form </xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:physicalDescription/*" at="last()" position="after" origin="instance('template')/mods:physicalDescription/mods:form"/>

                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:reformattingQuality) = 0]">
                                            <xforms:label><img src="images/add.gif"/>Reformatting Quality</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:physicalDescription/*" at="last()" position="after" origin="instance('template')/mods:physicalDescription/mods:reformattingQuality"/>
                                        </xforms:trigger>
                                    </dd>

                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:internetMediaType) = 0]">
                                            <xforms:label><img src="images/add.gif"/>Internet Media Type </xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:physicalDescription/*" at="last()" position="after" origin="instance('template')/mods:physicalDescription/mods:internetMediaType"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[count(mods:extent) = 0]">

                                            <xforms:label><img src="images/add.gif"/>Extent </xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:physicalDescription/*" at="last()" position="after" origin="instance('template')/mods:physicalDescription/mods:extent"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:digitalOrigin) = 0]">
                                            <xforms:label><img src="images/add.gif"/>Digital Origin</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:physicalDescription/*" at="last()" position="after" origin="instance('template')/mods:physicalDescription/mods:digitalOrigin"/>

                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[count(mods:note) = 0]">
                                            <xforms:label><img src="images/add.gif"/> Note</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:physicalDescription/*" at="last()" position="after" origin="instance('template')/mods:physicalDescription/mods:note"/>
                                        </xforms:trigger>
                                    </dd>
                        ...
                        <legend>
                            <xforms:trigger class="add" appearance="minimal">
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                                    ...
                                    <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="last()" position="after" origin="instance('basic')/mods:abstract"/>
                    ...
                    <fieldset>
                        <legend>
                            <xforms:trigger class="add" appearance="minimal">
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                                    <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="last()" position="after" origin="instance('basic')/mods:note"/>
                ...
                <xforms:case id="case3" selected="flase()">
                        ...
                        <legend>
                            <xforms:trigger class="add" appearance="minimal">
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                                    ...
                                    <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="last()" position="after" origin="instance('basic')/mods:typeOfResource"/>
                                ...
                                <dl class="optionalElements">
                                    ...
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[not(@collection)]">
                                            <xforms:label><img src="images/add.gif"/>Is a Collection?</xforms:label>
                                    ...
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[not(@manuscript)]">
                                            <xforms:label><img src="images/add.gif"/> Is a Manuscript?</xforms:label>
                    ...
                    <fieldset>
                        <legend>
                            <xforms:trigger class="add" appearance="minimal">
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                                    <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="last()" position="after" origin="instance('basic')/mods:genre"/>
                                ...
                                <div class="left">
                                    <p>
                                        <xforms:select1 ref="@authority" class="attribute">
                                            ...
                                            <xforms:itemset nodeset="instance('genre')/*">
                                        ...
                                        <xforms:select1 ref=".">
                                            ...
                                            <xforms:itemset nodeset="instance('genre')/*[@id = instance('metadata')/mods:genre[index('genreInfo')]/@authority]/*">
                                                <xforms:label ref="."/>
                                                <xforms:value ref="."/>
                                            </xforms:itemset>
                            ...
                            <p>
                                ...
                                <xforms:trigger class="add">
                                    <xforms:label>Add Selected</xforms:label>
                                        <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="last()" position="after" origin="instance('subjects')/*/*"/>
                                </xforms:trigger>
                                <xforms:select ref="instance('subjects')/*" appearance="full">

                                    <xforms:label/>
                                    <xforms:itemset nodeset="instance('subjectResponse')/*">
                                        <xforms:label style="display: block;" ref="*/*"/>
                                        <xforms:copy ref="*"/>
                                    </xforms:itemset>
                                </xforms:select>
                                ...
                                <dl class="optionalElements">
                                    ...
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[not(@ID)]">
                                            <xforms:label><img src="images/add.gif"/>ID</xforms:label>
                                    ...
                                    <dd>
                                        <xforms:trigger class="add" appearance="minimal" ref="self::node()[not(@xlink:href)]">
                                            <xforms:label><img src="images/add.gif"/>Link</xforms:label>
                                    ...
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[count(mods:note) = 0]">
                                            <xforms:label><img src="images/add.gif"/> Note </xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:relatedItem[index('relatedItem')]/*" at="index('relatedItem')" position="after" origin="instance('template')/mods:relatedItem/mods:note"/>
                ...
                <xforms:case id="case5" selected="false()">
                    ...
                    <fieldset>
                        <legend>
                            <xforms:trigger class="add" appearance="minimal">
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                                    <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="last()" position="after" origin="instance('basic')/mods:identifier"/>
                                ...
                                <dl class="optionalElements">
                                    ...
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[not(@invalid)]">
                                            <xforms:label><img src="images/add.gif"/>Invalid</xforms:label>
                    ...
                    <fieldset>
                        <legend>
                            <xforms:trigger class="add" appearance="minimal">
                                ...
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                                    <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="last()" position="after" origin="instance('basic')/mods:location"/>
                                ...
                                <div class="left">
                                    <p>
                                        <xforms:input ref="mods:physicalLocation">
                                            ...
                                            <xforms:trigger appearance="minimal" ref="self::node()[not(@authority)]">
                                                <xforms:label><img src="images/add.gif"/>Add Authority?</xforms:label>
                                    ...
                                    <p>
                                        <xforms:input ref="mods:url">
                                            ...
                                            <xforms:trigger appearance="minimal" ref="self::node()[not(@access)]">
                                                <xforms:label><img src="images/add.gif"/>Add Access Type?</xforms:label>
                                            ...
                                            <xforms:trigger appearance="minimal" ref="self::node()[not(@usage)]">
                                                <xforms:label><img src="images/add.gif"/>Primary Display?</xforms:label>
                                ...
                                <dl class="optionalElements">
                                    ...
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[not(mods:physicalLocation)]">
                                            <xforms:label><img src="images/add.gif"/>Physical Location</xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:location[index('location')]/*" at="index('location')" position="after" origin="instance('template')/mods:location/mods:physicalLocation[1]"/>
                                        </xforms:trigger>
                    ...
                    <fieldset>
                        <legend>
                            <xforms:trigger class="add" appearance="minimal">
                                ...
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                                    <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="last()" position="after" origin="instance('basic')/mods:accessCondition"/>
                    ...
                    <fieldset>
                        <legend>
                            <xforms:trigger class="add" appearance="minimal" ref="self::node()[not(mods:recordInfo)]">
                                <xforms:label><img src="images/add.gif" alt="Add"/></xforms:label>
                                    <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/*" at="last()" position="after" origin="instance('basic')/mods:recordInfo"/>
                                            ...
                                            <xforms:repeat nodeset="mods:languageTerm" id="langTerm">
                                                <p>
                                                  <xforms:input ref=".[not(@type = 'code')]">
                                                      ...
                                                      <!-- removed ref=".[not(following-sibling::*[@type = 'code'])]" -->
                                                      <xforms:trigger class="add" appearance="minimal" ref=".">
                                                          <xforms:label><img src="images/add.gif"/>Code</xforms:label>
                                                              <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:recordInfo/mods:languageOfCataloging/*" at="index('langInfo')" position="after" origin="instance('template')/mods:recordInfo/mods:languageOfCataloging/mods:languageTerm[@type = 'code']"/>
                                                      </xforms:trigger>
                                                  </xforms:input>
                                                  ...
                                                  <xforms:input ref=".[@type = 'code']">
                                                      ...
                                                      <!-- ref=".[not(following-sibling::*[@type = 'code'])]" -->
                                                      <xforms:trigger class="add" appearance="minimal" ref=".">
                                                          <xforms:label><img src="images/add.gif"/>Text</xforms:label>

                                                              <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:recordInfo/mods:languageOfCataloging/*" at="index('langInfo')" position="after" origin="instance('template')/mods:recordInfo/mods:languageOfCataloging/mods:languageTerm[@type = 'text']"/>
                                                      </xforms:trigger>
                                                  </xforms:input>
                                                </p>
                                                <p>
                                ...
                                <dl class="optionalElements">
                                    ...
                                    <dd>
                                        ...
                                        <xforms:trigger appearance="minimal" ref="self::node()[not(mods:recordContentSource)]">
                                            <xforms:label><img src="images/add.gif"/>Content Source </xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:recordInfo/*" position="after" origin="instance('basic')/mods:recordInfo/mods:recordContentSource"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[not(mods:recordCreationDate)]">
                                            <xforms:label><img src="images/add.gif"/>Creation Date </xforms:label>

                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:recordInfo/*" position="after" origin="instance('template')/mods:recordInfo/mods:recordCreationDate[1]"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[not(mods:recordChangeDate)]">
                                            <xforms:label><img src="images/add.gif"/>Change Date </xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:recordInfo/*" position="after" origin="instance('template')/mods:recordInfo/mods:recordChangeDate[1]"/>
                                        </xforms:trigger>

                                    </dd>
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[not(mods:recordIdentifier)]">
                                            <xforms:label><img src="images/add.gif"/>Record Identifier </xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:recordInfo/*" position="after" origin="instance('template')/mods:recordInfo/mods:recordIdentifier"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>

                                        <xforms:trigger appearance="minimal" ref="self::node()[not(mods:languageOfCataloging)]">
                                            <xforms:label><img src="images/add.gif"/>Language of Cataloging </xforms:label>
                                            <xforms:insert ev:event="DOMActivate" context="instance('metadata')" nodeset="instance('metadata')/mods:recordInfo/*" position="after" origin="instance('basic')/mods:recordInfo/mods:languageOfCataloging"/>
                                        </xforms:trigger>
                                    </dd>
                                    <dd>
                                        <xforms:trigger appearance="minimal" ref="self::node()[not(mods:recordOrigin)]">
                                            <xforms:label><img src="images/add.gif"/>Record Origin </xforms:label>
