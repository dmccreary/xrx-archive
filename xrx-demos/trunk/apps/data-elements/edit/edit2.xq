...
import module namespace auth='http://mdr.crossflow.com/authentication' at '/db/crossflo/modules/authentication.xqm';
   ...
   <body>
        ...
        <p>DRAFT Form v0.3</p>
            ...
            <xf:group ref="instance('views')/subclass-of-view">
                ...
                <xf:label>You will also be able to enter a list of contained Conceptual Data 
                Elements Elements and contained Properties from the Association Editor.</xf:label>
             </xf:group> 
