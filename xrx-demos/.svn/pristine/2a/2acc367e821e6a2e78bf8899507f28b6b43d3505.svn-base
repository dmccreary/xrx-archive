...
(: this updates the created by, date and time of the new record that was just saved :)
...
let $content := 
    <div>
        ...
        <div class="edit-controls">
             <a href="../views/view-item.xq?id={$original-id}" title="View {$original-id}">View User {$original-id}</a>
