...
<div class="content">
      ...
      <br/><br/>
      <h3>TEI Lite Elements</h3>
      <a href="tei-lite/list-named-schema-objects.xq">List TEI Lite Elements</a> A list of
      all the elements and attributes in the TEI Lite XML Schema.<br/>
